<!--
****--@file     questionsManagement_input
                ...
                <el-col :span="8">
                    <el-form-item label="年级：" prop="grade">
                        <el-select v-model="formValidate.grade" placeholder="请选择" @change="changeGrade">
                            <el-option v-for="num in 12" :key="num" :label="num | grade" :value="num"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            <el-col v-if="!formValidate.groups">
                <el-col :span="8">
                    <el-form-item label="添加知识点：">
                        <el-select @change="addKnowledge" v-model="knowledgeIds" filterable clearable placeholder="请选择">
...
<script>
    ...
    import qRadio from '../../common/questionEdit/radio' // 单选
    import qCheckbox from '../../common/questionEdit/checkbox' // 多选
    import qJudgment from '../../common/questionEdit/judgment' // 判断
    import qInput from '../../common/questionEdit/input' // 填空
    import qAnswer from '../../common/questionEdit/answer' // 问答

    import qGroup from '../../common/questionEdit/group' // 自由组题
    import qMix from '../../common/questionEdit/mix' // 公共候选项组题
    //当前组件引入全局的util
    let Util = null;
    export default {
        ...
        data() {
            return {
                rules,
                labelWidth: '100px',
                saveBtn: {title: '保存', callParEvent: 'saveData', type: 'success'},
                // 数据
                subjectList: [], // 科目
                knowledgeList: {}, // 知识点
            ...
            getEditData() {
                let opt = {
                    ajaxSuccess: res => {
                      ...
                      let that = this;
                      if (temp.indexOf('/static/question/') < 0 || temp.indexOf('/static/') < 0) {
                ...
                if (this.type == 'center') {
                    opt.ajaxParams.url = api.getCenter.path
                }
                this.ajax(opt)
            },
            /**

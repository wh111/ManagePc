            ...
            <div>
                <el-form :rules="rules" ref="formValidate" :model="formValidate" :inline="true" class="demo-ruleForm">
                    <el-row class="search-from">
                      <el-form-item label="题型" style="margin-left: 12px" prop="questionsTypeId">
        ...
        methods: {
            ...
            */
            ...
            changeSubject(val, sel) {
              ...
              this.formValidate.chapterId = sel.chapter;
                this.formValidate.textbookVersionId = sel.textbookVersion
                this.getKnowledge();
                this.setTableData();
            },

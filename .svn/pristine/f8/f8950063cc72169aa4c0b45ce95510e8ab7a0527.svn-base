  ...
  <el-row id="content" class="cuta_content">
    <el-form :rules="rules" ref="formValidate" :model="formValidate" label-width="160px">
      ...
      <el-form-item label="教师账号：" :span="8" prop="account">
        <el-input size="small" placeholder="请输入字母或数字" v-model="formValidate.account"></el-input>
      </el-form-item>
      ...
      <el-form-item label="上传身份证：">
        <el-col :span="14">
          <up-load-photo-well @upladSuccess="upladIdcardImgs1Success" :onlyOnePic="true"></up-load-photo-well>
          <p>身份证正面照</p>
        </el-col>
        <el-col :span="6">
          <up-load-photo-well @upladSuccess="upladIdcardImgs2Success" :onlyOnePic="true"></up-load-photo-well>
          <p>身份证背面照</p>
        </el-col>
      </el-form-item>
      <p>学历信息</p>
      ...
      <el-form-item label="上传教师资格证：">
        <up-load-photo-well @upladSuccess="upladTeachCertImgsSuccess"></up-load-photo-well>
      </el-form-item>
      ...
      <el-form-item label="任教学科：" prop="subject">
        <el-select v-model="formValidate.subject" placeholder="请选择" @change="queryTextbookVersion">
    ...
    <el-col align="center">
      ...
      <el-button size="small" class="tableMakeItemCancel" @click="cancle">取消</el-button>
    </el-col>
  </el-row>
</template>
<script>
        ...
        methods: {
            ...
            * */
            listenSubEvent (isLoadingFun) {
                ...
                this.formValidate.textbookVersionList[0].subject = this.formValidate.subject
                if (isSubmit) {

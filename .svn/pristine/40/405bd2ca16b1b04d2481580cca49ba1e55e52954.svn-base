<template>
  <div class="vue-xlsx-container">
      <el-button size="mini" class="xlsx-button" @click="handleUploadBtnClick" type="primary">上传
        <i class="el-icon-upload el-icon--right"></i>
      </el-button>

    <input id="upload-input" type="file" :accept="accept" class="c-hide hidden" @change="handkeFileChange">
  </div>
</template>

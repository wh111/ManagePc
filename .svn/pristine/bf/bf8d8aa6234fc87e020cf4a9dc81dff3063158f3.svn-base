<!--
****--@file     brushContest_list
****--@date     2017/12/1 下午6:49
****--@author   jhd
****--@describe   刷题大赛
-->
<template>
        ...
        <el-col>
            <div>
                <el-form label-width="100px" class="demo-ruleForm">
                  <el-col :span="14" style="margin-bottom:20px;margin-top: 15px">
            ...
            <div id="myTable" ref="myTable">
                <el-table align="center" :context="self" :height="dynamicHt" :data="tableData" tooltip-effect="dark"
                  ...
                  <el-table-column prop="index" label="序号" width="70px" align="center"
                    ...
                    <el-table-column label="发布者" prop="person" show-overflow-tooltip>
                        <template slot-scope="scope">
                            系统
                        </template>
                    </el-table-column>
...
<script>
  import add from './Congregation_add.vue'
  import show from './Congregation_show.vue'
  import api from './api'
  ...
  export default {
    ...
    methods: {
      ...
      init () {
        ...
        this.queryQptions = {
          url: api.list.path,
          params: {curPage: 1, pageSize: Util.pageInitPrams.pageSize, types: '0'}
        }
        this.setTableData()
      },
      /************************** 表格 ************************/

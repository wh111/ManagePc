<template>
    <div>
        <slot>
            <el-date-picker v-model="startDate" :type="type" :editable="false" placeholder="选择日期"
                            :picker-options="pickerOptions0" @change="handleStartTime"
                            style="width:130px;">
            </el-date-picker>
            {{text}}
            <el-date-picker v-model="endDate" align="right" :editable="false" :type="type" placeholder="选择日期"

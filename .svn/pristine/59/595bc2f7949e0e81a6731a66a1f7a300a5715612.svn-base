            ...
            <el-col>
                ...
                <el-form-item label="公用候选项：">
                        ...
                        <el-form-item labelWidth="30px" :label="index | getCharCode">
                            <el-col>
                                <p v-if="!edits['questionsOptions_'+index+'_content']">
                                    <el-input v-model="item.content" :disabled="lockQuestionsOptions"></el-input>
                                </p>
                                <div v-else>
                            ...
                            <el-col align="right" class="editTodoBtnBox" v-if="!lockQuestionsOptions">
                                <el-button @click="changeEdit('questionsOptions_'+index+'_content')">{{
                                    edits['questionsOptions_'+index+'_content'] ? '文本' : '图文' }}编辑
                                </el-button>
                                <el-button type="primary" @click="addquestionsOptions"
                                           icon="el-icon-circle-plus"></el-button>
                                <el-button :disabled="formValidate.questionsOptions.length<2"
                    ...
                    <el-col class="editTodoBtnBox" align="right">
                        <el-button :disabled="lockQuestionsOptions" @click="localSaveQuestionsOptions">保存候选项</el-button>
                        <el-button :disabled="editQuestionChild" @click="addChildQuestions">新增小题</el-button>
                    </el-col>
                </el-form-item>
            </el-col>
            <!-- 新建小题时隐藏表格 -->
        ...
        <template v-if="editQuestionChild">
            ...
            <el-col>
                <q-radio :from-data="tempQuestion" v-if="tempQuestion.basicType == 'Radio'"
                         :labelWidth="labelWidth" ref="Radio"
                         :questionsOptions="formValidate.questionsOptions"></q-radio>
                <q-checkbox :from-data="tempQuestion" v-if="tempQuestion.basicType == 'Checkbox'"
                            :labelWidth="labelWidth" ref="Checkbox"
                            :questionsOptions="formValidate.questionsOptions"></q-checkbox>
...
<script>
    /*当前组件必要引入*/
    import {mixQuestionEdit as rules} from '../../questionsCenter/rules'
    import {question, questionsOptionsItem} from '../../questionsCenter/questionsManagement/dataTemp' // 数据模版
    import viewUEditor from '../showUeditor.vue' // 富文本编辑器

    import questionDiffLevelOption from '../questionDiffLevelOption' // 难度组件
    ...
    export default {
        ...
        data() {
            return {
                ...
                lockQuestionsOptions: false, // 锁定候选项
        ...
        methods: {
            ...
            initEditState() {
                ...
                let editKey = ['questionsOptions_content'];
                editKey.map(k => {
                    let key = k.split('_');
            ...
            // 保存候选项
            localSaveQuestionsOptions() {
                this.lockQuestionsOptions = true;
            ...
            addKnowledge(id) {
                ...
                if (!(this.tempQuestion.knowledgeList instanceof Array)) {
                    this.tempQuestion.knowledgeList = []
                }
            ...
            cancelEdit() {
                // 解锁候选项
                this.lockQuestionsOptions = false;
                // 取消小题编辑模式
                this.editQuestionChild = false;
                // 初始化小题编辑索引
                this.editQuestionIndex = -1;

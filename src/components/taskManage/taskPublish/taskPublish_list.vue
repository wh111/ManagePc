<template>
  <div style="height: 100%;padding: 0" class="moudle-wrap modal clearfix" id="content" ref="content">
        <el-col>
            <div>
                <el-form class="demo-ruleForm" inline>
                    <el-row class="search-from">
                        <date-group :dateGroup="{text:'',startDate:formValidate.startTime,endDate:formValidate.endTime}"
                          ...
                          <el-form-item slot="start" prop="beginTime" label="开始时间" style="margin-left: 13px">

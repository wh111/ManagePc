    ...
    <div class="ctcs-content">
        <el-form ref="formValidate" :model="formValidate" label-width="100px">
            ...
            <el-form-item label="已选择知识点:">
                <el-tag style="margin-right: 5px" v-for="tag in formValidate.gamesGroupsKnowledgeList" :key="tag.id">
                    {{tag.knowledgeName}}
                </el-tag>
            </el-form-item>
        ...
        <div id="myTable" ref="myTable">
            <el-table align="center" :data="dataList" tooltip-effect="dark"
                ...
                <el-table-column label="操作" align="center" width="240">
                    <template slot-scope="scope">
                      <el-button size="small" type="success" class="tableMakeItem" @click="show(scope.row)">查看
                      </el-button>
                      <el-button class="tableMakeItem" :disabled="scope.row.status != '0'" size="small" type="warning"

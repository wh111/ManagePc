<template>
    <div class="cggg-content">
        <img v-if="formValidate.icon" :src=" resourceHttp + formValidate.icon" alt="">
        ...
        <el-table
            ...
            <el-table-column
                    ...
                    label="评价结果">
                <template slot-scope="scope">
                    {{ scope.row.result | commentResult }}
                </template>
            </el-table-column>
        ...
        methods: {
            init() {
                ...
                this.ajax({
                    ...
                    ajaxParams: {
                        url: api.statistics.path + '?types=0&productId=' + this.operailityData.id,
                ...
                this.ajax({
                    ...
                    ajaxParams: {
                        url: api.commentList.path + '?types=0&productId=' + this.operailityData.id,

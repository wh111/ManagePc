    ...
    <div>
        <el-form :rules="rules" ref="formValidate" :model="formValidate" label-width="120px">
            ...
            <el-form-item label="商品规格：" prop="spec">
                <el-input :disabled="isEdit" class="item" size="small" v-model="formValidate.spec"></el-input>
            </el-form-item>
            ...
            <el-form-item label="年级：">
                <el-select :disabled="isEdit" disabled size="small" v-model="formValidate.grade" placeholder="" @change="changGrade">

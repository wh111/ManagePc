<template>
    <div>
        <el-form :rules="rules" ref="formValidate" :model="formValidate" label-width="120px">
          ...
          <el-form-item label="折扣（折）" prop="discount">
            ...
            <!-- <el-form-item label="商品类别：">
                <el-select size="small" v-model="formValidate.category" placeholder="请选择">
                <el-option label="试卷" value="1"></el-option>
                <el-option label="教材" value="2"></el-option>
                <el-option label="教辅" value="3"></el-option>
                </el-select>
            </el-form-item> -->
            ...
            <el-form-item label="商品规格：" prop="spec">
                <el-input class="item" disabled size="small" v-model="formValidate.spec"></el-input>
                张试卷
            </el-form-item>
        ...
        <Modal
            ...
            <test-list v-if="addModal" @cancel="close" @choice="subCallback"></test-list>
            <div slot="footer"></div>
        </Modal>
    </div>
</template>
        ...
        methods: {
           ...
           * **/
            ...
            * **/
            ...
            changeChapter(val) {
//        if(this.formValidate.textbookVersionId != '' &&this.formValidate.subject != '' &&this.formValidate.grade != ''){
                this.ajax({

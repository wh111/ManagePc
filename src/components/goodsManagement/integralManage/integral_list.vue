<template>
    <div class="moudle-wrap modal clearfix" id="content" ref="content">
        <el-col>
            <div>
                <el-form ref="formValidate" :rules="rules" :model="formValidate" class="demo-ruleForm" label-width="120px">
                    <el-row class="search-from">
                        <el-col :span="4">
                          <el-form-item label="商品状态：" prop="status" style="margin-left: -27px">
                        ...
                        <el-col :span="4">
                            <el-form-item label="年级：" prop="grade">
                                <el-select size="small" v-model="formValidate.grade" placeholder="" @change="changeGrade">
                                    <el-option label="全部" value=""></el-option>
            ...
            <div id="myTable" ref="myTable">
                <el-table align="center" :context="self" :height="dynamicHt" :data="tableData" tooltip-effect="dark"
                  ...
                  <el-table-column prop="index" align="center" label="序号" width="70px"
                    ...
                    <el-table-column label="原价(积分)" align="center" prop="originalPrice" show-overflow-tooltip></el-table-column>
                    <el-table-column label="现价(积分)" align="center" prop="currentPrice" show-overflow-tooltip></el-table-column>
...
<script>
  import add from './integral_add.vue'
  import show from './integral_show.vue'
  import edit from './integral_edit.vue'
  import api from './api'

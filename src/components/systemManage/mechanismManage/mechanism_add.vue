<template>
    <el-row class="smm_box">
        <el-form ref="formValidate" :model="formValidate" :rules="rules" label-width="160px">
            ...
            <!--</el-select>-->
            <!--</el-form-item>-->
            <distpicker label-width="160px" @selected="getArea" ref="distpicker" :rules="distpickerRules"></distpicker>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             * */
            submitForm(formName) {
                if (this.formValidate.yearFee && !(/^[0-9]+$/.test(this.formValidate.yearFee))) {
                    this.$message.error('年费必须是数字')
                }

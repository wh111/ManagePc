        ...
        <el-form :labelWidth="labelWidthStr">
            <el-col>
                ...
                <el-form-item label="标题：">
                    ...
                    <el-col class="editTodoBtnBox" align="right">
                        <el-button @click="changeEdit('title')">{{ edits.title ? '文本' : '图文' }}编辑</el-button>
                    </el-col>
                </el-form-item>
            </el-col>
            ...
            <el-col>
                ...
                <el-form-item label="正确答案：" prop="answer">
                    <el-checkbox-group v-model="formValidate.answer">
                        <el-checkbox v-for="(item, index) in formValidate.questionsOptions" :key="index"
                                     :label="index+''">{{index | getCharCode}}
                        </el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
            </el-col>
            <el-col>
                <el-form-item label="题目解析：" prop="answerExplain">
                    ...
                    <el-col class="editTodoBtnBox" align="right">
                        <el-button @click="changeEdit('answerExplain')">{{ edits.answerExplain ? '文本' : '图文' }}编辑
                        </el-button>
                    </el-col>
                </el-form-item>
            </el-col>
...
<script>
    /*当前组件必要引入*/
    import {questionsOptionsItem} from '../../questionsCenter/questionsManagement/dataTemp' // 数据模版
    ...
    export default {
        ...
        methods: {
            ...
            init() {
                ...
                let answer = data.answer && data.answer.split('|') || [];
                this.formValidate = data;
                this.formValidate.answer = answer;
            ...
            checkData() {
                ...
                if (this.formValidate.answer.length < 2) {
                    this.errorMess('答案至少选择两个');
                    return false
                }
                return true
            },

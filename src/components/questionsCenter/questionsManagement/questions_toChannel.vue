  ...
  <div class="questions_toChannel">
    <el-row class="but-spaceone">
      <el-col :span="3" :offset="2">
          <Icon style="font-size: 50px;margin: 10px 0 0 4px;" type="arrow-down-a"/>
      </el-col>
      <el-col :span="16">
    ...
    <el-row class="but-space">
      <el-col :span="3" :offset="2">
          <Icon style="font-size: 50px;margin-top: 0;" type="upload"/>
      </el-col>
      <el-col :span="4">
        <el-upload
                class="upload-demo"
                action='/api/manager/question/import'
      ...
      <el-col :span="8">
        <el-upload
          class="upload-demo"
          action='/api/manager/questions/wordImport'
          :on-preview="handlePreview"
          :on-remove="handleRemove"
          :on-success="handleAvatarSuccess"
          ...
          :file-list="fileList">
          <!--<el-button size="small" type="primary" style="padding: 7px 15px;">点击上传</el-button>-->
          <el-button @click="setUrl" size="small" type="primary" style="padding: 7px 15px;" >点击上传</el-button>
          <div slot="tip" class="linebot">只能上传doc/docx文件</div>
        </el-upload>
      </el-col>
    </el-row>
    <br>
...
//      this.http = http+ 'static/template/部门人员信息模板-普通人员.xls';
        ...
        methods: {
            ...
            beforeAvatarUpload1 (file) {
                ...
                let str=file.name.split('.')[file.name.split('.').length - 1]
                if (str!= 'doc'&&str != 'docx') {
                    this.errorMess('请上传doc/docx格式文件')
                    return false
                }else {
